...
HRESULT CEditImageLibrary::AddBitmap(LPSTR szFilename)
{
	if((m_nNumBitmaps<0) || (m_nNumBitmaps>MAX_BITMAPS))return E_FAIL;

	if(FAILED(OpenBitmap(szFilename, m_nNumBitmaps+1)))return E_FAIL;
...
HRESULT CEditImageLibrary::SetBitmap(sg_uint16 nReference, LPSTR szFilename)
{
	if( (nReference<1) || (nReference>MAX_BITMAPS))return E_FAIL;
	if(FAILED(OpenBitmap(szFilename, nReference)))return E_FAIL;

	strcpy_s(m_szBitmapFilenameA[nReference-1], countof(m_szBitmapFilenameA[nReference-1]), szFilename);
	return S_OK;
}


void CEditImageLibrary::SetNumBitmaps(sg_uint16 nNumBitmaps)
{
	m_nNumBitmaps=nNumBitmaps;
}

HRESULT CEditImageLibrary::AddEntry(
	sg_uint16 x, 
	sg_uint16 y, 
	sg_uint16 nWidthSrc, 
...
HRESULT CEditImageLibrary::SetEntry(
...
HRESULT CEditImageLibrary::AutoGenerateData(
	sg_uint16 nBitmap, 
	sg_uint16 nWidth, 
	sg_uint16 nHeight, 
	sg_uint16 nXSpacing, 
...
HRESULT CEditImageLibrary::SaveData(LPSTR szFilename)
{
	//Declare headers
...
HRESULT CEditImageLibrary::LoadData(LPSTR szFilename)
{
	//Declare headers
	IMGLIBHEADER lbHeader;
	IMGDBHEADER dbHeader;
...
HRESULT CEditImageLibrary::BuildLibrary(LPSTR szFilename)
{
	IMGLIBHEADER lbHeader;
	IMGHEADER imHeader;
...
HRESULT CEditImageLibrary::ImportLibrary(LPSTR szFilename)
{
	IMGLIBHEADER lbHeader;
	IMGHEADER imHeader;
	HANDLE hFile;
